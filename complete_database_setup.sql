...
-- =====================================================
-- 1. SUBJECTS TABLE (Compatible with existing code)
-- =====================================================
CREATE TABLE IF NOT EXISTS subjects (
    ...
    type VARCHAR(20) NOT NULL DEFAULT 'theory' CHECK (type IN ('theory', 'lab', 'mcq', 'free', 'cross-department')),
...
CREATE TABLE IF NOT EXISTS faculty (
    ...
    type VARCHAR(50) NOT NULL DEFAULT 'regular' CHECK (type IN (
        'regular', 'professor', 'associate_professor', 'assistant_professor', 
...
-- =====================================================
-- 3. TIMETABLES TABLE (For storing generated timetables)
-- =====================================================
CREATE TABLE IF NOT EXISTS timetables (
    ...
    time_slot INTEGER NOT NULL CHECK (time_slot >= 0 AND time_slot <= 5),
